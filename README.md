...
## Содержание
- [Функции проекта Kittygram](#функции-проекта)
...
<img src="https://github.com/user-attachments/assets/1386c885-9f7c-454b-bfee-ab6fab1276db" alt="Главная страница до регистрации/входа" width="300"/>

После регистрации, на главной странице сайта пользователю станет доступен весь список котиков, загружаемых пользователями.
<img src="https://github.com/user-attachments/assets/d69d0d52-2ed0-4d5f-b478-4dcde36cbc86" alt="Главная страница после регистрации/входа" width="300"/>
...
<img src="https://github.com/user-attachments/assets/a893cfe5-5154-422c-8183-585254b09096" alt="Форма добавления кота" width="300"/>

Для добавления котика, необходимо заполнить поля *Имя кота* и *Год рождения*, остальные поля для заполнения необязательны.
...
<img src="https://github.com/user-attachments/assets/2aa0447b-100c-48b2-8579-c858292c5519" alt="Форма добавления достижений кота" width="300"/>
